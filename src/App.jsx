...
const STYLES = `
  ...
  *{margin:0;padding:0;box-sizing:border-box;}
  ...
  @keyframes drawerIn{from{transform:translateX(12px);opacity:0}to{transform:translateX(0);opacity:1}}
  ...
  /* Prevent tiny overflow on very small devices */
...
function Navbar({ lang, setLang, cart, page, setPage }) {
  ...
  const navPadX = isSmall ? 16 : isMobile ? 18 : 40;
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 5000 }}>
        ...
        <div
          style={{
            ...
            gap: 14,
            animation: "drawerIn 0.22s cubic-bezier(.23,1,.32,1)",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              ...
              >
                <span style={{ fontFamily: "'Playfair Display',serif", fontWeight: 900, fontSize: 15, color: "#fff" }}>M</span>
              </div>
              <div>
                <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 20, letterSpacing: 4, color: C.white, lineHeight: 1 }}>MOZHELA</div>
          ...
          <div style={{ height: 1, background: "rgba(245,240,240,0.08)", margin: "6px 0 4px" }} />
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {navLinks.map((l) => (
              <button
                ...
                onClick={() => go(l.id)}
                style={{
                  background: page === l.id ? "rgba(232,0,26,0.12)" : "transparent",
                  border: `1px solid ${page === l.id ? "rgba(232,0,26,0.35)" : "rgba(245,240,240,0.08)"}`,
                  color: page === l.id ? C.white : C.gray,
                  padding: "12px 12px",
                  borderRadius: 10,
                  cursor: "pointer",
                  textAlign: "start",
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            >
              {isAr ? "Switch to EN" : "التبديل للعربية"}
            </button>
          ...
          <div style={{ marginTop: "auto", paddingTop: 10, color: C.faint, fontSize: 11, lineHeight: 1.8 }}>
            {isAr ? "MOZHELA — تجربة تسوق فاخرة." : "MOZHELA — a premium shopping experience."}
          </div>
        </div>
      </div>
    );
  ...
  return (
    <>
      ...
      >
        {/* Left: Logo */}
        <div onClick={() => setPage("home")} style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
          <div
            style={{
              width: 36,
              height: 36,
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 24, letterSpacing: 4, color: C.white, lineHeight: 1, whiteSpace: "nowrap" }}>MOZHELA</div>
            <div style={{ fontSize: 8, letterSpacing: 6, color: C.red, fontWeight: 700, whiteSpace: "nowrap" }}>FASHION HOUSE</div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          {!isMobile && (
            <>
              ...
              {/* Checkout */}
              <button className="btn-primary" onClick={() => setPage("checkout")} style={{ padding: "9px 20px", borderRadius: 4, fontSize: 12, fontWeight: 800, letterSpacing: 1 }}>
                {isAr ? "الدفع" : "CHECKOUT"}
              </button>
            </>
          )}
...
/* ═══════════════════════════════════════
   HERO (Responsive paddings & layout)
═══════════════════════════════════════ */
function Hero({ lang, setPage }) {
  ...
  const padX = isTiny ? 14 : isSmall ? 18 : isMobile ? 24 : 80;
  const maxW = isMobile ? 720 : 800;
  ...
  return (
    <section style={{ height: "100vh", position: "relative", overflow: "hidden", display: "flex", alignItems: "center" }}>
      ...
      {/* Decorative elements (hide on tiny to avoid clutter) */}
      {!isSmall && (
        <>
      ...
      >
        ...
        {/* Title */}
        <h1 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: "clamp(54px,11vw,160px)", lineHeight: 0.9, letterSpacing: 2, color: C.white, marginBottom: 0 }}>
          {s.title}
        </h1>
        <h1
          style={{
        ...
        <p style={{ color: C.gray, fontSize: isSmall ? 14 : 16, lineHeight: 1.8, marginBottom: isSmall ? 26 : 40, fontFamily: "'Cairo',sans-serif", maxWidth: 520, fontWeight: 400 }}>
          {s.sub}
        </p>

        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <button className="btn-primary" onClick={() => setPage("shop")} style={{ padding: isSmall ? "13px 28px" : "15px 40px", borderRadius: 3, fontSize: 13, fontWeight: 900, letterSpacing: 2, fontFamily: "'Bebas Neue',sans-serif" }}>
          ...
          <button
            ...
            style={{
              ...
              color: C.gray,
              padding: isSmall ? "13px 22px" : "15px 32px",
              borderRadius: 3,
              cursor: "pointer",
              fontSize: 13,
              fontWeight: 900,
            ...
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = "rgba(245,240,240,0.25)";
              e.currentTarget.style.color = C.gray;
            }}
          >
            {isAr ? "اكتشفي أكثر" : "EXPLORE MORE"}
          </button>
        </div>

        {/* Stats */}
        <div style={{ display: "flex", gap: isSmall ? 18 : 40, marginTop: isSmall ? 34 : 56, paddingTop: isSmall ? 18 : 32, borderTop: `1px solid rgba(245,240,240,0.08)`, flexWrap: "wrap" }}>
          {[["500+", isAr ? "منتج" : "Products"], ["50K+", isAr ? "عميلة" : "Customers"], ["4.9★", isAr ? "تقييم" : "Rating"]].map(([n, l], i) => (
            <div key={i} style={{ minWidth: 90 }}>
              <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 26 : 32, color: s.accent, letterSpacing: 1 }}>{n}</div>
      ...
      {/* Slide number */}
      {!isSmall && (
        <div style={{ position: "absolute", bottom: 24, right: 20, fontFamily: "'Bebas Neue',sans-serif", fontSize: 13, color: C.faint, letterSpacing: 3, zIndex: 3 }}>
  ...
  return (
    ...
    >
      ...
      <div style={{ height: 320, overflow: "hidden", position: "relative" }}>
        ...
        >
          <button className="btn-primary" onClick={handleAdd} style={{ width: "100%", padding: "12px", borderRadius: 2, fontSize: 12, fontWeight: 900, letterSpacing: 2, fontFamily: "'Bebas Neue',sans-serif" }}>
        ...
        <div style={{ position: "absolute", top: 12, left: 12, display: "flex", flexDirection: "column", gap: 5 }}>
          ...
          {disc && <span style={{ background: C.gold, color: C.black, fontSize: 9, fontWeight: 900, padding: "4px 8px", letterSpacing: 1, fontFamily: "'Bebas Neue',sans-serif" }}>-{disc}%</span>}
        </div>
      </div>

      {/* Info */}
      <div style={{ padding: "16px 18px 20px", direction: isAr ? "rtl" : "ltr" }}>
        <div style={{ fontSize: 10, color: C.red, letterSpacing: 3, fontWeight: 700, marginBottom: 5, fontFamily: "'Bebas Neue',sans-serif" }}>{p.cat.toUpperCase()}</div>
        <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 16, color: C.white, fontWeight: 700, marginBottom: 10, lineHeight: 1.3 }}>{isAr ? p.nameAr : p.name}</h3>

        {/* Rating */}
        <div style={{ display: "flex", gap: 2, marginBottom: 12, alignItems: "center" }}>
          {[...Array(5)].map((_, i) => (
            <span key={i} style={{ color: i < p.rating ? C.gold : "rgba(245,240,240,0.15)", fontSize: 11 }}>
              ★
            </span>
          ))}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
          ...
          <button className="btn-primary" onClick={handleAdd} style={{ padding: "8px 16px", borderRadius: 2, fontSize: 11, fontWeight: 900, letterSpacing: 1, fontFamily: "'Bebas Neue',sans-serif", flexShrink: 0 }}>
            {added ? "✓" : isAr ? "سلة" : "CART"}
          </button>
        </div>
      </div>
...
/* ═══════════════════════════════════════
   PRODUCT MODAL (Responsive grid -> column on small)
═══════════════════════════════════════ */
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 9000, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      ...
      >
        ...
        <div style={{ position: "relative", overflow: "hidden" }}>
          <img src={p.img} alt={p.name} style={{ width: "100%", height: "100%", objectFit: "cover", minHeight: isSmall ? 320 : 500 }} onError={(e) => (e.target.src = "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&q=80")} />
        ...
        {/* Details */}
        <div style={{ padding: isSmall ? "24px 18px" : "40px 36px", display: "flex", flexDirection: "column", gap: 20 }}>
          <button
            onClick={onClose}
            style={{
              position: "absolute",
          ...
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: isSmall ? 22 : 28, color: C.white, fontWeight: 700, lineHeight: 1.2 }}>{isAr ? p.nameAr : p.name}</h2>

          <div style={{ display: "flex", gap: 4, alignItems: "center", flexWrap: "wrap" }}>
            {[...Array(5)].map((_, i) => (
              <span key={i} style={{ color: i < p.rating ? C.gold : "rgba(245,240,240,0.15)", fontSize: 14 }}>
                ★
              </span>
            ))}
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 12, flexWrap: "wrap" }}>
            <span style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 34 : 40, color: C.white, letterSpacing: 1 }}>${p.price}</span>
              ...
              {["XS", "S", "M", "L", "XL", "XXL"].map((s) => (
                <button
                  ...
                  style={{
                    width: 40,
                    height: 40,
                    border: `1px solid ${size === s ? C.red : "rgba(245,240,240,0.15)"}`,
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", border: `1px solid ${C.border}`, borderRadius: 2, overflow: "hidden" }}>
              {["-", qty, "+"].map((v, i) => (
                <button
                  key={i}
                  onClick={() => (i === 0 ? setQty((q) => Math.max(1, q - 1)) : i === 2 ? setQty((q) => q + 1) : null)}
                  style={{
                    width: 36,
                    height: 36,
                    background: i === 1 ? "transparent" : "rgba(255,255,255,0.04)",
                    border: "none",
                    color: C.white,
                    fontSize: i === 1 ? 15 : 18,
          ...
          {/* Add to cart */}
          <button className="btn-primary" onClick={handleAdd} style={{ padding: "16px", borderRadius: 2, fontSize: 14, fontWeight: 900, letterSpacing: 3, fontFamily: "'Bebas Neue',sans-serif", width: "100%" }}>
            {added ? (isAr ? "✓ أُضيف للسلة" : "✓ ADDED TO CART") : isAr ? "أضف للسلة" : "ADD TO CART"}
          </button>

          {/* Tabs */}
          <div>
            <div style={{ display: "flex", borderBottom: `1px solid rgba(245,240,240,0.08)`, marginBottom: 14, overflowX: "auto" }}>
            ...
            <p style={{ color: C.gray, fontSize: 13, lineHeight: 1.9, fontFamily: "'Cairo',sans-serif" }}>
              {tab === "desc"
                ? isAr
                  ? "قطعة استثنائية من مجموعة موزيلا الحصرية، مصنوعة بأرقى الأقمشة وأدق التفاصيل"
                  : "An exceptional piece from Mozhela's exclusive collection, crafted with the finest fabrics and meticulous attention to detail."
                : tab === "care"
                ? isAr
                  ? "غسيل يدوي بماء بارد، تجنب التجفيف الآلي، كي على درجة حرارة منخفضة"
                  : "Hand wash in cold water, avoid tumble drying, iron on low heat."
                : isAr
                ? "شحن مجاني للطلبات فوق $200، التسليم خلال 3-5 أيام عمل"
                : "Free shipping on orders over $200, delivery within 3-5 business days."}
            </p>
          </div>
        </div>
      </div>
...
function Shop({ lang, cart, onAdd, filter: initFilter = "all" }) {
  ...
  const isSmall = useMediaQuery("(max-width: 520px)");
  const isTiny = useMediaQuery("(max-width: 360px)");
  const padX = isTiny ? 14 : isSmall ? 16 : isMobile ? 20 : 40;

  const filtered = PRODUCTS.filter((p) => filter === "all" || p.cat === filter).sort((a, b) => (sort === "price-asc" ? a.price - b.price : sort === "price-desc" ? b.price - a.price : sort === "rating" ? b.rating - a.rating : 0));

  return (
    <>
      <section style={{ minHeight: "100vh", padding: `120px ${padX}px 80px`, background: C.black, direction: isAr ? "rtl" : "ltr" }}>
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 52, display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 16 }}>
            <div>
              ...
              <h1 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 46 : 64, letterSpacing: 2, color: C.white, lineHeight: 0.9 }}>{isAr ? "المتجر" : "SHOP"}</h1>
...
function Cart({ lang, cart, setCart, setPage }) {
  ...
  if (cart.length === 0)
    return (
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: padX, background: C.black, direction: isAr ? "rtl" : "ltr" }}>
        <div style={{ fontSize: 80, marginBottom: 24, opacity: 0.3 }}>🛍</div>
        <h2 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 34 : 42, color: C.white, letterSpacing: 2, marginBottom: 12 }}>{isAr ? "السلة فارغة" : "CART IS EMPTY"}</h2>
        <p style={{ color: C.faint, marginBottom: 28, fontFamily: "'Cairo',sans-serif", textAlign: "center" }}>{isAr ? "ابدأي التسوق الآن" : "Start shopping now"}</p>
  ...
  return (
    <section style={{ minHeight: "100vh", padding: `120px ${padX}px 80px`, background: C.black, direction: isAr ? "rtl" : "ltr" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <h1 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 46 : 64, color: C.white, letterSpacing: 2, marginBottom: 8 }}>{isAr ? "سلة التسوق" : "YOUR CART"}</h1>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 360px", gap: 24, alignItems: "start" }}>
            ...
            {cart.map((item, i) => (
              <div
                ...
                style={{
                  ...
                  alignItems: "center",
                  background: C.card,
                  border: `1px solid rgba(245,240,240,0.05)`,
              ...
              >
                <img src={item.img} alt={item.name} style={{ width: 80, height: 80, objectFit: "cover", borderRadius: 2, flexShrink: 0 }} onError={(e) => (e.target.src = "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=200&q=80")} />
                ...
                <div style={{ display: "flex", alignItems: "center", border: `1px solid ${C.border}`, borderRadius: 2, overflow: "hidden" }}>
                  {["-", item.qty || 1, "+"].map((v, i2) => (
                    <button
                      key={i2}
                      onClick={() => (i2 === 0 ? updateQty(item.id, Math.max(1, (item.qty || 1) - 1)) : i2 === 2 ? updateQty(item.id, (item.qty || 1) + 1) : null)}
                ...
                <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 20, color: C.white, letterSpacing: 1, minWidth: 70, textAlign: "center" }}>${item.price * (item.qty || 1)}</div>

                <button
                  onClick={() => remove(item.id)}
                  style={{ background: "none", border: "none", color: C.faint, cursor: "pointer", fontSize: 18, padding: 4, transition: "color 0.2s" }}
          ...
          {/* Summary */}
          <div style={{ background: C.card, border: `1px solid ${C.border}`, padding: "28px 24px", position: isMobile ? "relative" : "sticky", top: 90 }}>
            ...
            <button className="btn-primary" onClick={() => setPage("checkout")} style={{ width: "100%", padding: "16px", borderRadius: 2, fontSize: 14, fontWeight: 900, letterSpacing: 3, fontFamily: "'Bebas Neue',sans-serif" }}>
              {isAr ? "إتمام الشراء →" : "CHECKOUT →"}
            </button>
            <button
              onClick={() => setPage("shop")}
              style={{ width: "100%", marginTop: 10, background: "transparent", border: `1px solid rgba(245,240,240,0.1)`, color: C.gray, padding: "12px", borderRadius: 2, cursor: "pointer", fontSize: 12, fontWeight: 700, letterSpacing: 1, fontFamily: "'Cairo',sans-serif", transition: "all 0.3s" }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = C.white;
                e.currentTarget.style.color = C.white;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = "rgba(245,240,240,0.1)";
                e.currentTarget.style.color = C.gray;
              }}
            >
...
function Checkout({ lang, cart, setCart, setPage }) {
  ...
  if (placed)
    return (
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", background: C.black, padding: padX }}>
        ...
        <h2 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 38 : 48, color: C.white, letterSpacing: 2, marginBottom: 12, textAlign: "center" }}>{isAr ? "تم تأكيد طلبك!" : "ORDER CONFIRMED!"}</h2>
  ...
  return (
    <section style={{ minHeight: "100vh", padding: `120px ${padX}px 80px`, background: C.black, direction: isAr ? "rtl" : "ltr" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        <h1 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 46 : 64, color: C.white, letterSpacing: 2, marginBottom: 8 }}>{isAr ? "إتمام الطلب" : "CHECKOUT"}</h1>
        <div style={{ width: 60, height: 2, background: C.red, marginBottom: 40 }} />

        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 380px", gap: 24, alignItems: "start" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {/* Delivery */}
            <div style={{ background: C.card, border: `1px solid ${C.border}`, padding: isSmall ? "18px" : "28px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  ["name", isAr ? "الاسم الكامل" : "Full Name", "text"],
                  ["address", isAr ? "العنوان الكامل" : "Full Address", "text"],
                  ["phone", isAr ? "رقم الهاتف" : "Phone Number", "tel"],
                ].map(([k, pl, type]) => (
                  <input
                    key={k}
                    type={type}
            ...
            {/* Coupon */}
            <div style={{ background: C.card, border: `1px solid ${C.border}`, padding: isSmall ? "18px" : "24px" }}>
          ...
          {/* Order Summary */}
          <div style={{ background: C.card, border: `1px solid ${C.border}`, padding: isSmall ? "18px" : "28px", position: isMobile ? "relative" : "sticky", top: 90 }}>
            ...
            <button className="btn-primary" onClick={handlePlace} style={{ width: "100%", padding: "16px", borderRadius: 2, fontSize: 14, fontWeight: 900, letterSpacing: 3, fontFamily: "'Bebas Neue',sans-serif" }}>
              {isAr ? "تأكيد الطلب ✓" : "PLACE ORDER ✓"}
            </button>
            <div style={{ display: "flex", gap: 8, marginTop: 16, justifyContent: "center", flexWrap: "wrap" }}>
              {["VISA", "MC", "AMEX", "PAYPAL"].map((b) => (
                <span key={b} style={{ background: "rgba(255,255,255,0.06)", border: `1px solid rgba(255,255,255,0.1)`, padding: "4px 8px", fontSize: 9, fontWeight: 900, color: C.faint, letterSpacing: 1, fontFamily: "'Bebas Neue',sans-serif" }}>
                  {b}
                </span>
              ))}
            </div>
...
function Footer({ lang, setPage }) {
  ...
  const isMobile = useMediaQuery("(max-width: 980px)");
  const isSmall = useMediaQuery("(max-width: 520px)");
  const padX = isSmall ? 16 : isMobile ? 20 : 40;

  return (
    <footer style={{ background: C.deep, borderTop: `1px solid rgba(232,0,26,0.1)`, padding: `60px ${padX}px 24px`, direction: isAr ? "rtl" : "ltr" }}>
      <div style={{ maxWidth: 1300, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr 1fr 1fr", gap: 40, marginBottom: 48 }}>
          <div>
            ...
            <p style={{ color: C.faint, fontSize: 13, lineHeight: 1.9, maxWidth: 320, fontFamily: "'Cairo',sans-serif" }}>{isAr ? "بيت الموضة الراقية — نصنع لك التميز في كل قطعة" : "The house of refined fashion — crafting distinction in every piece."}</p>
            <div style={{ marginTop: 20, fontSize: 12, color: C.faint, fontFamily: "'Cairo',sans-serif" }}>
              {isAr ? "من السبت إلى الخميس 10ص - 10م" : "Sat–Thu 10AM–10PM"}
              <br />
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {col.items.map(([id, label]) => (
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (id !== "#") e.currentTarget.style.color = C.red;
                    }}
                    onMouseLeave={(e) => (e.currentTarget.style.color = C.faint)}
                  >
                    {label}
        ...
        <div style={{ borderTop: `1px solid rgba(245,240,240,0.06)`, paddingTop: 20, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            {["VISA", "MC", "AMEX", "PAYPAL", "DISCOVER"].map((b) => (
              <span key={b} style={{ background: "rgba(255,255,255,0.05)", border: `1px solid rgba(255,255,255,0.08)`, padding: "4px 8px", fontSize: 8, fontWeight: 900, color: C.faint, letterSpacing: 1, fontFamily: "'Bebas Neue',sans-serif" }}>
                {b}
              </span>
            ))}
          </div>
...
function Home({ lang, setPage, cart, onAdd }) {
  ...
  return (
    <>
      ...
      {/* Categories Strip */}
      <section style={{ background: C.deep, padding: `56px ${padX}px`, borderTop: `1px solid rgba(232,0,26,0.1)`, direction: isAr ? "rtl" : "ltr" }}>
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
            ...
            {[
              ...
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  const ov = e.currentTarget.querySelector(".cat-overlay");
              ...
              >
                <img src={c.img} alt={c.label} style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.7s cubic-bezier(.23,1,.32,1)" }} onError={(e) => (e.target.src = "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?w=600&q=80")} />
                ...
                <div style={{ position: "absolute", bottom: 24, left: 24, right: 24 }}>
                  ...
                  <div style={{ marginTop: 12, fontSize: 11, color: C.red, fontWeight: 900, letterSpacing: 2, fontFamily: "'Bebas Neue',sans-serif" }}>{isAr ? "تسوقي الآن ←" : "SHOP NOW →"}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Featured */}
      <section style={{ padding: `80px ${padX}px`, background: C.black, direction: isAr ? "rtl" : "ltr" }}>
        <div style={{ maxWidth: 1300, margin: "0 auto" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 40, flexWrap: "wrap", gap: 12 }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 44 : 52, color: C.white, letterSpacing: 2, lineHeight: 0.9 }}>{isAr ? "المميزة" : "FEATURED"}</h2>
            </div>
            <button
              onClick={() => setPage("shop")}
              style={{ background: "transparent", border: `1px solid ${C.border}`, color: C.gray, padding: "11px 24px", borderRadius: 2, cursor: "pointer", fontSize: 11, fontWeight: 900, letterSpacing: 2, fontFamily: "'Bebas Neue',sans-serif", transition: "all 0.3s" }}
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = C.red;
      ...
      <section
        style={{
          margin: `0 ${padX}px 80px`,
          background: `linear-gradient(135deg,${C.crimson},${C.black})`,
          border: `1px solid rgba(232,0,26,0.2)`,
          padding: isSmall ? "28px 18px" : "52px 48px",
          display: "flex",
          justifyContent: "space-between",
          alignItems: "center",
          flexWrap: "wrap",
      ...
      >
        <div>
          ...
          <h2 style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: isSmall ? 40 : 52, color: C.white, letterSpacing: 2, lineHeight: 0.9, marginBottom: 8 }}>{isAr ? "خصم 30%" : "30% OFF"}</h2>
        ...
        <button className="btn-primary" onClick={() => setPage("pyjamas")} style={{ padding: isSmall ? "14px 28px" : "16px 44px", borderRadius: 2, fontSize: 15, fontWeight: 900, letterSpacing: 3, fontFamily: "'Bebas Neue',sans-serif", background: C.white, color: C.black }}>
